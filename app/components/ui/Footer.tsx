...
const Footer = () => {
  ...
  return (
    <div className={`mt-2 pt-2  border-t w-full items-center bottom-0  border-white/10 flex bg-background/80 text-pretty text-primary justify-center transition-all duration-300   ${shantell.className}`}>
